...
Pod::Spec.new do |s|
  s.name         = "anon-aadhaar-react-native"
  ...
  # This could be used to include dylib in the bundle, but might not work for release
  # s.resource = 'ios/Frameworks/CircuitBindings.{xcframework}'
